...
// AddOrReplaceCondition adds or replaces the passed condition in the past array of conditions
...
// GetCondition returns the condition with the given type, if it exists. If the condition does not exist it returns false.
